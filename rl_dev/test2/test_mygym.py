...
from gym_core_optimization_157_2_1 import Simulate3_Core_157 as PWR157
import numpy as np
import random
import yaml
...
state1={}
for key,value in at.core_dict['fuel'].items():
    state1[key]=value['Value']
with open('state1.yml', 'w') as outfile:
     yaml.dump(state1, outfile, default_flow_style=False)