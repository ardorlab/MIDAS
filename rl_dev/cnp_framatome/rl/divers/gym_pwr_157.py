...
# First basic gym environmet implementation for pwr_157 game.
...
model=PPO('MlpPolicy', env, verbose=1, seed=2, gamma=0.999, tensorboard_log="tensorboard_ppo",policy_kwargs=policy_kwargs)
#model=PPO.load("ppo_mlp_pwr157_64_64")
#model.set_env(DummyVecEnv([lambda: env]))
model.learn(total_timesteps=26*5000)
model.save("ppo_mlp_pwr157_64_64")
obs = env.reset()
