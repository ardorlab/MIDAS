...
import gym
from gym_core_optimization_157_3 import Simulate3_Core_157 as PWR157
...
#env.env.evaluate()
#env.render()
policy_kwargs = dict(net_arch=dict(pi=[126, 52], qf=[252, 252]))
model=SAC('MlpPolicy', env, verbose=1, seed=1000, gamma=0.99, tensorboard_log="tensorboard_sac",policy_kwargs=policy_kwargs)
#model=SAC.load("ppo_mlp_pwr157_64_64")
#model.set_env(DummyVecEnv([lambda: env]))
model.learn(total_timesteps=52*10000)
model.save("sac_mlp_pwr157_126_52")
obs = env.reset()
