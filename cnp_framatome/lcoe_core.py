...
lcoe_param={'Cycle': 'Once_Through',
            ...
            'Storage_Time': 5.0+core_param['EFPD']*core_param['Batches']/365.25,
            'Disposal_Time': core_param['EFPD']*core_param['Batches']/365.25}
...
lcoe,bu, asb_cost = LCOE(core_param,lcoe_param, asb_param)
print(f"The LCOE once-through fuel cycle cost is: {lcoe}")
...
lcoe2_param['Reprocess_Time'] = 5.0+core_param['EFPD']*core_param['Batches']/365.25
lcoe2_param['Rep_Waste_Time'] = 5.0+core_param['EFPD']*core_param['Batches']/365.25
lcoe2_param['RepU_Time'] = 1.0 + 5.0 + core_param['EFPD']*core_param['Batches']/365.25

lcoe,lcoe1, lcoe2, pu_price, bu = LCOE2(core_param,lcoe2_param, asb_param)
print(f"The LCOE twice-through fuel cycle cost is: {lcoe}")
print(f"The discharge burnup is: {bu}")
