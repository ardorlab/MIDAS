...
model.restore(midas_data.__path_to_save_model__[1]+"-"+str(midas_data.__training_epochs_model_2__)+".ckpt") 
# print(midas_data.__path_to_save_model__[1]+"-"+str(midas_data.__training_epochs__)+".ckpt")
