...
if __name__ == "__main__":
    ...
    start_time = TT.time()
    ## run all the loop 
    pathtotest = '/home/khnguy22/Deeponet-midas/MIDAS/corereload197-surrogate/output_files_case01_300gen/Gen_299_Indv_89'
    ...
    for root, dirs, files in os.walk(pathtotest):
        for file in files:
            if file.endswith('.inp'):
                ...
                print('True data',[float(i) for i in array])
                print('Prediction', cycle,cbc,fq,fd)
                print("Parallel processing complete:", inputfile)
#np.save('preddata_50.npy',np.array(preddata))
#np.save('truedata_50.npy',np.array(truedata))
