...
datapath_new = "/home/khnguy22/Deeponet-midas/MIDAS/surmodel/retraindata/"
...
# )
# # # # # Compile and Train
pathtest = '/home/khnguy22/Deeponet-midas/MIDAS/surmodel/tempcoremodel/MIONet_PWR3D_core'
restoremodel = pathtest+"-"+str(200000)+".ckpt"
print(restoremodel)
model.train(epochs=20000,
                                     batch_size=batch_size, 
                                     model_restore_path=restoremodel,
                                  #    callbacks=[early_stopping_callback],
                                     model_save_path="./testmodel/check")
